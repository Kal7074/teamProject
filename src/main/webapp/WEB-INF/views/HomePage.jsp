...
%> <!-- 세션에 저장된 로그인 정보 -->
<c:set var="login" value="${empty userID ? false : true }"/>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="btn btn-light"><a class="nav-link active" aria-current="page" href="#!">홈페이지 소개</a></li>
       ...
       <!-- Section-->
		...
		<div class="section1" style="text-align: center;">
			<a href="https://korean.visitseoul.net/map-guide-book">
				<div class="Mainbox1" style="width: 350px; height: 200px; display: inline-block; margin:50px;">
						<img id="mainPics" src="resources/images/today1.jpg" class="d-block w-100">
						<div class="text1">여행가이드 북 보러가기</div>
				</div>
			</a>
			<a href="./list">
				<div class="Mainbox1" style="width: 350px; height: 200px;display: inline-block; margin:50px;">
						<img id="mainPics" src="resources/images/today2.jpg" class="d-block w-100">
						<div class="text1">베스트 후기글 보러가기</div>
				</div>
			</a>
		</div>
			<!-- <div class="container" style="background-color: gray;" width:960px; height:350px;> -->
		<div class="section2" style="text-align: center;">
			<a href="https://kr.hotels.com/">
				<div class="Mainbox1" style="width: 350px; height: 200px; display: inline-block; margin:25px; margin-top: 0px; margin-bottom: 50px;">
						<img id="mainPics" src="resources/images/today3.jpg" class="d-block w-100">
						<div class="text1">숙소 가격 비교하러 가기</div>
				</div>
			</a> 	
			<a href="https://sky.interpark.com/">
				<div class="Mainbox1" style="width: 350px; height: 200px;display: inline-block; margin:25px;margin-top: 0px; margin-bottom: 50px;">
						<img id="mainPics" src="resources/images/today4.jpg" class="d-block w-100">
						<div class="text1">항공권 가격비교하러 가기</div>
				</div>
			</a>	
			<a href="#">
				<div class="Mainbox1" style="width: 350px; height: 200px;display: inline-block; margin:25px;margin-top: 0px; margin-bottom: 50px;">
						<img id="mainPics" src="resources/images/today5.jpg" class="d-block w-100">
						<div class="text1">베스트 후기글 보러가기</div>
				</div>
			</a>
			</div>
